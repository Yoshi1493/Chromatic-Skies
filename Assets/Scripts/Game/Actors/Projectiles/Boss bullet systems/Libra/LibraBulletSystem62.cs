...
public class LibraBulletSystem62 : BossShooter<BossBullet>
{
    ...
    List<BossBullet> bullets = new(ParentBulletCount);
    List<BossBullet> childBullets = new(ParentBulletCount * (int)Mathf.Pow(ChildBulletCount, WaveCount));
