...
public class CapricornMovementSystem6 : BossMovement
{
    protected override IEnumerator Move()
    {
        ...
        yield return parentShip.MoveFromTo(p2, p3, 2f);
