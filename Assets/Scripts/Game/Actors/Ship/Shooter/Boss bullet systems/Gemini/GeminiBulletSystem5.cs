...
public class GeminiBulletSystem5 : BossShooter<BossBullet>
{
    ...
    protected override IEnumerator Shoot()
    {
        ...
        GeminiMovementSystem5 movementSystem = (ownerShip as Boss).GetCurrentMovementSystem() as GeminiMovementSystem5;            //no
